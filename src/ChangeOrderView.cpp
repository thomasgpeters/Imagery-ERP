...
void ChangeOrderView::refresh()
{
    ...
    for (int ci = 0; ci < (int)data_.changeOrders.size(); ci++) {
        ...
        coCard->addWidget(std::make_unique<Wt::WText>(
            "<div class=\"co-header\">"
        ...
        auto addImpact = [&](const std::string& l, const std::string& v, const std::string& cls) {
            impactMetrics->addWidget(std::make_unique<Wt::WText>(
        ...
        // Line items
        if (!co.items.empty()) {
            coCard->addWidget(std::make_unique<Wt::WText>("<h4 class=\"detail-section\">Change Items</h4>"));
            ...
            for (int ii = 0; ii < (int)co.items.size(); ii++) {
                ...
                itemTable->elementAt(row, 0)->addWidget(std::make_unique<Wt::WText>(actionBadge));
        ...
        coCard->addWidget(std::make_unique<Wt::WText>("<h4 class=\"detail-section\">Approval Signature</h4>"));
    ...
    content_->addWidget(std::make_unique<Wt::WText>("<h3 class=\"section-title\">Submit New Change Order</h3>"));
    ...
    r1->addWidget(std::make_unique<Wt::WText>("<span class=\"field-label\">Title:</span>"));
    ...
    r2->addWidget(std::make_unique<Wt::WText>("<span class=\"field-label\">Requested By:</span>"));
    ...
    form->addWidget(std::make_unique<Wt::WText>("<span class=\"field-label\">Description:</span>"));
    ...
    form->addWidget(std::make_unique<Wt::WText>("<span class=\"field-label\">Reason for Change:</span>"));
    ...
    r3->addWidget(std::make_unique<Wt::WText>("<span class=\"field-label\">Additional Hours:</span>"));
    ...
    r3->addWidget(std::make_unique<Wt::WText>("<span class=\"field-label\">Schedule Impact:</span>"));
    ...
    r3->addWidget(std::make_unique<Wt::WText>("<span class=\"field-unit\">weeks</span>"));
